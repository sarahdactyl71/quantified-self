...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Diary = __webpack_require__(3);
	...
	$(document).ready(function () {
	  ...
	  Diary.allFoodsToHTML().then(function (foodsSelectionHTML) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Food.post = function (event) {
	  ...
	  $.post(`${API}/api/v1/foods`, data).then(Food.appendNew).catch(Food.handleError);
	};
	...
	Food.delete = function (event) {
	  ...
	  $.ajax({
	    ...
	    id: parentID
	  }).then(Food.removeFood).catch(Food.handleError);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	  ...
	  $.ajax({
	    ...
	    success: function (data) {
	      $.each(data.foods, function (index, food) {
	        $('.breakfast-foods-table .main-foods').append(`<tr class="food-row breakfast" id="${food.id}">
	            <td> ${food.name} </td>
	...
	Diary.getSnackFoods = function () {
	  $.ajax({
	    ...
	    success: function (data) {
	      $.each(data.foods, function (index, food) {
	        $('.snacks-foods-table .main-foods').append(`<tr class="food-row snacks" id="${food.id}">
	            <td> ${food.name} </td>
	...
	Diary.getLunchFoods = function () {
	  $.ajax({
	    ...
	    success: function (data) {
	      $.each(data.foods, function (index, food) {
	        $('.lunch-foods-table .main-foods').append(`<tr class="food-row lunch" id="${food.id}">
	            <td> ${food.name} </td>
	...
	Diary.getDinnerFoods = function () {
	  $.ajax({
	    ...
	    success: function (data) {
	      $.each(data.foods, function (index, food) {
	        $('.dinner-foods-table .main-foods').append(`<tr class="food-row dinner" id="${food.id}">
	            <td> ${food.name} </td>
	...
	Diary.addToBreakfast = function () {
	  $('input:checked').each(function () {
	    ...
	    $('.breakfast-foods-table .main-foods').append(`<tr class="food-row breakfast">
	...
	Diary.addToLunch = function () {
	  $('input:checked').each(function () {
	    ...
	    event.preventDefault();
	    Diary.addFoodToMeal(this);
	    $('.lunch-foods-table .main-foods').append(`<tr class="food-row lunch">
	        <td> ${$($foodTDs[0]).text()} </td>
	...
	Diary.addToDinner = function () {
	  $('input:checked').each(function () {
	    ...
	    event.preventDefault();
	    Diary.addFoodToMeal(this);
	    $('.dinner-foods-table .main-foods').append(`<tr class="food-row dinner">
	        <td> ${$($foodTDs[0]).text()} </td>
	...
	Diary.addToSnacks = function () {
	  $('input:checked').each(function () {
	    ...
	    event.preventDefault();
	    Diary.addFoodToMeal(this);
	    $('.snacks-foods-table .main-foods').append(`<tr class="food-row dinner">
	        <td> ${$($foodTDs[0]).text()} </td>
